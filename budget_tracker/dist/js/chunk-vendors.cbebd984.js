 ...
 * limitations under the License.
 */
const Q=L;function Y(t,e={}){let n=t;if("object"!==typeof e){const t=e;e={name:t}}const r=Object.assign({name:F,automaticDataCollectionEnabled:!1},e),o=r.name;if("string"!==typeof o||!o)throw K.create("bad-app-name",{appName:String(o)});if(n||(n=(0,s.T9)()),!n)throw K.create("no-options");const a=V.get(o);if(a){if((0,s.bD)(n,a.options)&&(0,s.bD)(r,a.config))return a;throw K.create("duplicate-app",{appName:o})}const c=new i.h1(o);for(const i of B.values())c.addComponent(i);const l=new G(n,r,c);return V.set(o,l),l}function X(t=F){const e=V.get(t);if(!e&&t===F&&(0,s.T9)())return Y();if(!e)throw K.create("no-app",{appName:t});return e}function J(t,e,n){var r;let s=null!==(r=U[t])&&void 0!==r?r:t;n&&(s+=`-${n}`);const o=s.match(/\s|\//),a=e.match(/\s|\//);if(o||a){const t=[`Unable to register library "${s}" with version "${e}":`];return o&&t.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&a&&t.push("and"),a&&t.push(`version name "${e}" contains illegal characters (whitespace or "/")`),void h.warn(t.join(" "))}$(new i.uA(`${s}-version`,(()=>({library:s,version:e})),"VERSION"))}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vo{constructor(){this._=void 0}}function jo(t,e,n){return t instanceof $o?function(t,e){const n={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:t.seconds,nanos:t.nanoseconds}}}};return e&&as(e)&&(e=cs(e)),e&&(n.fields.__previous_value__=e),{mapValue:n}}(n,e):t instanceof Ho?Wo(t,e):t instanceof qo?Ko(t,e):function(t,e){const n=zo(t,e),i=Qo(n)+Qo(t.Pe);return ws(n)&&ws(t.Pe)?Fo(i):Lo(t.serializer,i)}(t,e)}function Bo(t,e,n){return t instanceof Ho?Wo(t,e):t instanceof qo?Ko(t,e):n}function zo(t,e){return t instanceof Go?function(t){return ws(t)||function(t){return!!t&&"doubleValue"in t}(t)}(e)?e:{integerValue:0}:null}class $o extends Vo{}class Ho extends Vo{constructor(t){super(),this.elements=t}}function Wo(t,e){const n=Yo(e);for(const i of t.elements)n.some((t=>ps(t,i)))||n.push(i);return{arrayValue:{values:n}}}class qo extends Vo{constructor(t){super(),this.elements=t}}function Ko(t,e){let n=Yo(e);for(const i of t.elements)n=n.filter((t=>!ps(t,i)));return{arrayValue:{values:n}}}class Go extends Vo{constructor(t,e){super(),this.serializer=t,this.Pe=e}}function Qo(t){return ss(t.integerValue||t.doubleValue)}function Yo(t){return xs(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const N=new Map;function L(t,e){const n=D(t);F(n,e),U(n,e)}function F(t,e){const n=N.get(t);if(n)for(const i of n)i(e)}function U(t,e){const n=j();n&&n.postMessage({key:t,fid:e}),B()}let V=null;function j(){return!V&&"BroadcastChannel"in self&&(V=new BroadcastChannel("[Firebase] FID Change"),V.onmessage=t=>{F(t.data.key,t.data.fid)}),V}function B(){0===N.size&&V&&(V.close(),V=null)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
